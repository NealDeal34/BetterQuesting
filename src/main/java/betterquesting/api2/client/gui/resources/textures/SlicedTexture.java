        ...
        if (err != GL11.GL_NO_ERROR) {
            ...
            switch (err) {
                case GL11.GL_INVALID_ENUM:
                    errName = "GL_INVALID_ENUM(1280)";
                    break;
                case GL11.GL_INVALID_VALUE:
                    errName = "GL_INVALID_VALUE(1281)";
                    break;
                case GL11.GL_INVALID_OPERATION:
                    errName = "GL_INVALID_OPERATION(1282)";
                    break;
                case GL11.GL_STACK_OVERFLOW:
                    errName = "GL_STACK_OVERFLOW(1283)";
                    break;
                case GL11.GL_STACK_UNDERFLOW:
                    errName = "GL_STACK_UNDERFLOW(1284)";
                    break;
                case GL11.GL_OUT_OF_MEMORY:
                    errName = "GL_OUT_OF_MEMORY(1285)";
                    break;
                default:
                    errName = "Unknown(" + err + ")";
            }
